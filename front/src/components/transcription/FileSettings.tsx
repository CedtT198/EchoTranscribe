...
const FileSettings: React.FC<SettingsModalProps> = ({ settings, setSettings }) => {
    ...
    return(
        <>
            <button className="btn rounded-pill mt-2" type='button' data-toggle="modal" data-target=".modal-full">
                                        ...
                                        <div className="list-group mb-5 shadow text-left">
                                            ...
                                            <div className="list-group-item">
                                                <div className="row align-items-center">
                                                    ...
                                                    <div className="col-auto">
                                                        <div className="custom-control custom-switch">
                                                            <input type="checkbox" className="custom-control-input" id="withDiarization"
                                                            checked={settings.withDiarization}
                                                            onChange={(e) => updateSetting('withDiarization', e.target.checked)}
                                                            />
                                                            <label className="custom-control-label" htmlFor="withDiarization"></label>
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>
                                            ...
                                            <div className="list-group-item">
                                                <div className="row align-items-center">
                                                    ...
                                                    <div className="col-auto">
                                                        <div className="custom-control custom-switch">
                                                            <input type="number" className="form-control" size={1} min="2" max="10"
                                                            disabled={!settings.withDiarization}
                                                            value={settings.maxPeople}
                                                            onChange={(e) => updateSetting('maxPeople', Number(e.target.value))}
                                                            />
                                                        </div>
                                                    </div> 
                                                </div>
